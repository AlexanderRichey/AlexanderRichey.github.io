...
My reason for trying to maintain some level of intellectual humility is grounded, ultimately,  in a conflict between two philosophical views that I’m committed to. The first view is *realism,* which says, for any domain it’s applied to, that the facts of that domain — whatever it is — are objective and independent. The second view is *certainty,* which refers to the state of having infallible knowledge about something. The problem is that these two views are incompatible. When one accepts realism about any domain, one necessarily acknowledges that her understanding of that domain is fallible. This fallibility, however, contradicts the notion of certainty. Therefore, one must give up either certainty or realism, on pain of inconsistency, for whatever domain is in question. When it comes to domains that I am a realist about, such as the external world, for example, my response to this dilemma is to give up on certainty and to embrace humility.

In the next few paragraphs, I’m going to clarify the concepts of realism and certainty more fully, formulate and advance an argument in favor of my position, and discuss some of its implications. The reason I think this argument is important is that, in almost all matters of human life, we are concerned with realist domains. Questions of love, politics, and one’s bank account balance, for example, are all questions about realist domains. Therefore, if the adoption of realism, for any domain, necessitates a more modest epistemic stance toward that domain, then adopting an attitude of intellectual humility towards almost all questions of importance in human life becomes imperative.
